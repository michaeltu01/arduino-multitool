...
void test_tuner_transitions() { //COMMENT OUT fsm() in loop in arduino_multitool
    //transition 1-2
...
// const state_inputs testInputs[1] = {{false, false}
// };

// const state_vars testVarsIn[1] = {{100, 0, 0, 0, true, false}

// };

// const state_vars testVarsOut[1] = {{100, 0, 0, 0, false, false}
// };
